...
import com.example.config.ReadDataSource;
...
public class UserService {  
     ...
     * @throws Exception 
     */  
    public void wirteAndRead(User u) throws Exception{  
    ...
    public void readAndWirte(User u) throws Exception{  
        //为了测试,3个库中id=1的user_name是不一样的  
    ...
    public void updateUser(){
    	User user = new User();
    	user.setId("1");
    	user.setUserName("ouyangqian");
    	userMapper.updateByPrimaryKeySelective(user);
    	 int i = 1/0;
    	System.out.println(userMapper.findById("1"));
    }
    
    public Integer selectUserLevel(String id){
