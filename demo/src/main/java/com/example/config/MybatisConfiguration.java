...
public class MybatisConfiguration {
	...
	public SqlSessionFactory sqlSessionFactorys() throws Exception {
		...
		try {
			...
			// 读取配置
			sessionFactoryBean.setTypeAliasesPackage("com.example.pojo");
			...
			Interceptor[] plugins = new Interceptor[] { pageHelper(),
					new SqlPrintInterceptor() ,mapperInterceptor()};
	...
	public AbstractRoutingDataSource roundRobinDataSouceProxy() {
		...
		targetDataSources.put(DataSourceType.read.getType() + "1",
				readDataSource01);
	...
	public PlatformTransactionManager annotationDrivenTransactionManager() {
		return new DataSourceTransactionManager(
				(DataSource) SpringContextUtil
						.getBean("roundRobinDataSouceProxy"));
	}
